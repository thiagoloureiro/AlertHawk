...
public class PushNotifier: IPushNotifier
{
    public async Task SendNotification(string message, NotificationPush notificationPush)
    {
        ...
        notificationPush.PushNotificationBody.data.message = notificationPush.PushNotificationBody.data.message.Contains("Success") ? "\\n\u2705 " + message : "\\n\u274c " + message;
        notificationPush.PushNotificationBody.notification.body = notificationPush.PushNotificationBody.notification.body.Contains("Success") ? "\\n\u2705 " + message : "\\n\u274c " + message;
